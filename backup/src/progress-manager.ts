...
export class ProgressManager {
	...
	private drawProgressBar(label: string, value: number, total: number, char: string = '='): string {
	...
	updateProgress(progress: ResearchProgress) {
		...
		const lines = [
			...
			this.drawProgressBar('Queries: ', progress.completedQueries, progress.totalQueries, '█')
		];
